...
describe 'Taggable To Preserve Order' do
  ...
  it 'should return tag list in the order the tags were created' do
    ...
    expect(@taggable.instance_variable_get('@tag_list').instance_of?(ResearchActsAsTaggableOn::TagList)).to be_truthy

    expect(-> {
      @taggable.save
    }).to change(ResearchActsAsTaggableOn::Tag, :count).by(3)
...
describe 'Taggable' do
  ...
  it 'should be able to create tags' do
    ...
    expect(@taggable.instance_variable_get('@skill_list').instance_of?(ResearchActsAsTaggableOn::TagList)).to be_truthy
  ...
  it 'should be able to select taggables by subset of tags using ActiveRelation methods' do
    ...
    @found_taggables_by_tag = TaggableModel.joins(:tags).where(ResearchActsAsTaggableOn.tags_table => {name: ['bob']})
    @found_taggables_by_skill = TaggableModel.joins(:skills).where(ResearchActsAsTaggableOn.tags_table => {name: ['ruby']})
  ...
  it 'should not care about case' do
    ...
    expect(ResearchActsAsTaggableOn::Tag.all.size).to eq(1)
  ...
  it 'should be able to get all tag counts on model as whole' do
    ...
    expect(TaggableModel.all_tag_counts(order: "#{ResearchActsAsTaggableOn.tags_table}.id").first.count).to eq(3) # ruby
  end
  ...
  it 'should be able to get all tags on model as whole' do
    ...
    expect(TaggableModel.all_tags(order: "#{ResearchActsAsTaggableOn.tags_table}.id").first.name).to eq('ruby')
  end
  ...
  it 'should be able to get scoped tag counts' do
    ...
    expect(TaggableModel.tagged_with('ruby').tag_counts(order: "#{ResearchActsAsTaggableOn.tags_table}.id").first.count).to eq(2) # ruby
  ...
  it 'should be able to get all scoped tag counts' do
    ...
    expect(TaggableModel.tagged_with('ruby').all_tag_counts(order: "#{ResearchActsAsTaggableOn.tags_table}.id").first.count).to eq(3) # ruby
  end
  ...
  it 'should be able to get all scoped tags' do
    ...
    expect(TaggableModel.tagged_with('ruby').all_tags(order: "#{ResearchActsAsTaggableOn.tags_table}.id").first.name).to eq('ruby')
  end
  ...
  context 'Duplicates' do
    context 'should not create duplicate taggings' do
      ...
      context 'case sensitive' do
        it '#add' do
          expect(lambda {
            ...
            bob.save
          }).to change(ResearchActsAsTaggableOn::Tagging, :count).by(3)
        end
        it '#<<' do
          expect(lambda {
            bob.tag_list << 'social'
            ...
            bob.save
          }).to change(ResearchActsAsTaggableOn::Tagging, :count).by(2)
      ...
      context 'case insensitive' do
        before(:all) { ResearchActsAsTaggableOn.force_lowercase = true }
        after(:all) { ResearchActsAsTaggableOn.force_lowercase = false }
      ...
      expect {
        thread_count.times.map do |idx|
          Thread.start do
            ...
            begin
              connor.save
            rescue ResearchActsAsTaggableOn::DuplicateTagError
              # second save should succeed
              connor.save
            end
          end
        end.map(&:join)
      }.to change(ResearchActsAsTaggableOn::Tag, :count).by(5)
    end
  end
  ...
  describe 'grouped_column_names_for method' do
    it 'should return all column names joined for Tag GROUP clause' do
      ...
      expect(@taggable.grouped_column_names_for(ResearchActsAsTaggableOn::Tag))
      .to eq("#{ResearchActsAsTaggableOn.tags_table}.id, #{ResearchActsAsTaggableOn.tags_table}.name, #{ResearchActsAsTaggableOn.tags_table}.taggings_count, #{ResearchActsAsTaggableOn.tags_table}.type")
    end
