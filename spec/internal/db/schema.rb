ActiveRecord::Schema.define version: 0 do
  create_table ResearchActsAsTaggableOn.tags_table, force: true do |t|
    t.string :name
    t.integer :taggings_count, default: 0
    t.string :type
  end
  add_index ResearchActsAsTaggableOn.tags_table, ['name'], name: 'index_tags_on_name', unique: true

  create_table ResearchActsAsTaggableOn.taggings_table, force: true do |t|
    t.integer :tag_id
  ...
  add_index ResearchActsAsTaggableOn.taggings_table, :tag_id , name: 'index_taggings_on_tag_id'

  # above copied from
  # generators/research_acts_as_taggable_on/migration/migration_generator
