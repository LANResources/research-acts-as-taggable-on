...
begin
  ...
  require 'research_acts_as_taggable_on/engine'
  rescue LoadError
...
ResearchActsAsTaggableOn.delimiter is deprecated \
and will be removed from v4.0+, use  \
a ResearchActsAsTaggableOn.default_parser instead
WARNING
      @delimiter = string
    end
...
ActiveSupport.on_load(:active_record) do
  extend ResearchActsAsTaggableOn::Taggable
  include ResearchActsAsTaggableOn::Tagger
end
