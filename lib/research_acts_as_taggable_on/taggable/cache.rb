    ...
    def self.included(base)
      ...
      base.instance_eval do
        ...
        def _add_tags_caching_methods
          send :include, ResearchActsAsTaggableOn::Taggable::Cache::InstanceMethods
          extend ResearchActsAsTaggableOn::Taggable::Cache::ClassMethods
        ...
        #   the call to :columns as @research_acts_as_taggable_on_cache_columns
        ...
        def columns
          @research_acts_as_taggable_on_cache_columns ||= begin
            db_columns = super
        ...
        def reset_column_information
          super
          @research_acts_as_taggable_on_cache_columns = nil
        end
      end
    end
        ...
        tag_types.map(&:to_s).each do |tag_type|
          if self.class.send("caching_#{tag_type.singularize}_list?")
            if tag_list_cache_set_on(tag_type)
              list = tag_list_cache_on(tag_type).to_a.flatten.compact.join("#{ResearchActsAsTaggableOn.delimiter} ")
