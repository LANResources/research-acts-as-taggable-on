module ResearchActsAsTaggableOn::Taggable::TaggedWithQuery
  class AnyTagsQuery < QueryBase
    ...
    def alias_name(tag_list)
      ...
      taggings_alias = adjust_taggings_alias(
          "#{alias_base_name[0..4]}#{taggings_context[0..6]}_taggings_#{ResearchActsAsTaggableOn::Utils.sha_prefix(tag_list.join('_'))}"
       )
